/*! AeroGear JavaScript Library - v2.1.0-dev - 2014-11-11
...
(function( AeroGear, undefined ) {
    AeroGear.SyncEngine = function () {
        if ( ! ( this instanceof AeroGear.SyncEngine ) ) {
            return new AeroGear.SyncEngine();
        }
...
(function( AeroGear, undefined) {
    AeroGear.SyncClient = function ( config ) {
        if ( ! ( this instanceof AeroGear.SyncClient ) ) {
            return new AeroGear.SyncClient( config );
        }
        ...
        var ws,
            sendQueue = [],
            that = this,
            syncEngine = config.syncEngine || new AeroGear.SyncEngine();
