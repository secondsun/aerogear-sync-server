...
public class DiffMatchPatch {
    ...
    private final float patchDeleteThreshold;
    ...
    private DiffMatchPatch(final Builder builder) {
        ...
        matchDistance = builder.matchDistance;
        patchDeleteThreshold = builder.patchDeleteThreshold;
        patchMargin = builder.patchMargin;
        matchMaxbits = builder.matchMaxbits;
    }
    ...
    public static final class Builder {
        ...
        private float patchTimeout = 1.0f;
    ...
    protected String[] diffHalfMatch(String text1, String text2) {
        ...
        String[] hm1 = diffHalfMatch(longtext, shorttext,
                (longtext.length() + 3) / 4);
        // Check again based on the third quarter.
        String[] hm2 = diffHalfMatch(longtext, shorttext,
                (longtext.length() + 1) / 2);
        String[] hm;
     ...
     */
    private String[] diffHalfMatch(String longtext, String shorttext, int i) {
     ...
     */
    public String diffPretyyHtml(LinkedList<Diff> diffs) {
    ...
    public int matchMain(String text, String pattern, int loc) {
        ...
        if (text.equals(pattern)) {
            ...
            // Do a fuzzy compare.
            return matchBitmap(text, pattern, loc);
        }
    }
     ...
     * @return Best match index or -1.
     */
    protected int matchBitmap(String text, String pattern, int loc) {
        assert (matchMaxbits == 0 || pattern.length() <= matchMaxbits)
                : "Pattern too long for this application.";

        // Initialise the alphabet.
        Map<Character, Integer> s = matchAlpabet(pattern);
            ...
            for (int j = finish; j >= start; j--) {
                ...
                if ((rd[j] & matchmask) != 0) {
                    ...
                    if (score <= score_threshold) {
                        ...
                        best_loc = j - 1;
                        if (best_loc > loc) {
                            // When passing loc, don't exceed our current matchDistance from loc.
     ...
     */
    protected Map<Character, Integer> matchAlpabet(String pattern) {
