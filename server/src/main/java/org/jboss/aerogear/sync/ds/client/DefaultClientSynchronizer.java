...
import org.jboss.aerogear.sync.ds.*;
import org.jboss.aerogear.sync.ds.Diff;
import org.jboss.aerogear.sync.ds.client.ClientSynchronizer;
...
public class DefaultClientSynchronizer implements ClientSynchronizer<String> {
    ...
    private static LinkedList<DiffMatchPatch.Diff> asDiffUtilDiffs(final LinkedList<org.jboss.aerogear.sync.ds.Diff> diffs) {
